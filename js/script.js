...
document.getElementById("adminLoginForm").addEventListener("submit", function (e) {
  ...
  if (validUserIds.includes(userId) && centerCode === validCenterCode && password === validPassword) {
      ...
      window.location.href = "https://docs.google.com/spreadsheets/d/12UTU5b-n_al0DWlb63xKkDB1RI0IIw_nBv8SomR70xs/edit?usp=sharing"; // Change this to your actual dashboard
  } else {
